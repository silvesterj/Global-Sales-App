...
public class CalculateTask extends AsyncTask<Void, IProgress, Void> {
	...
	protected Void doInBackground(Void... arg0) {
		...
		try {
			...
			} else if (m_productName.equals("N1")) {
				PxCalculatorUtil.doNovinsoft(new PxHandler(this));
			} else if (m_productName.equals("M1")) {
				PxCalculatorUtil.doManulife(new PxHandler(this));
