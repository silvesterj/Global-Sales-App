==================================================================
Read-me for using the distributables for Embedded Calculator Push Mode
===================================================================
...
Find the jars libraries required for the PX Embedded Calculator Runtime environment and other Utility jars namely below
a.FiaJNI.jar
b.pxjavaruntime.jar
c.PxUtils.jar
d.PxVal.jar
...
2.Native Libraries for support the PxRuntime Environment to be found in "PxTestApp\libs\armeabi" of the Code base 
...
a. For any android app,please ensure to enable the Development IDE having Native support.The developed apps have dependency
...
1. PxCalculatorHome Object need some initial Setting files for initialising the PX Runtime Environment.
...
2. The copied "productxpress" directory has the "install/Etc" Directory i..e having settings file and the "products"
...
file in the Android Device by connecting through USB.
...
5. Ensure that Application starts and select the appropriate Product and then "press Calculate"
