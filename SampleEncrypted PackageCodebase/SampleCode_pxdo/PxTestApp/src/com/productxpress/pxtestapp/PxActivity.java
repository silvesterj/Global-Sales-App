...
public class PxActivity extends Activity {
	...
	private void updateMemoryInfoPreOptimize(MemoryInfo memoryInfo) {
		...
		nativePrivateDirtyPreOptimize.setText(toMemoryValueString(memoryInfo.nativePrivateDirty));
		dalvikPssPreOptimize.setText(toMemoryValueString(memoryInfo.dalvikPss));
		dalvikPrivateDirtyPreOptimize.setText(toMemoryValueString(memoryInfo.dalvikPrivateDirty));
	}
