...
extern NSString *const SAVED_CHECKSUM_PATH_KEY_NAME; // key for NSUserDefaults
extern NSString *const WEB_RESOURCES_DIR;
extern NSString *const DIRECT_UPDATE_SUCCEEDED;
...
+ (void)setAppChecksumWWWPath:(NSString *)checksum;
